...
typedef	int 	UART_INIT( void *pHandle, uint8_t nPort, uint32_t nBaud, BOOL bDMAEn );
...
typedef void 	UART_LOCK( void const *pHandle );
typedef void 	UART_UNLOCK( void const *pHandle);
...
/******************************************************************************
 @Description 	: Serial interface link to DMA
...
******************************************************************************/
void SerialLinkDMA( PUART_HANDLE pHandle, void *pDmaTxHandle, void *pDmaRxHandle );
